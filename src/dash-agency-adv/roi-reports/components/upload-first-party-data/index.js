    ...
    return (
      <div className="mb10">
        ...
        <div className="mt5">
          ...
          <label>
            <input key={counter} type="file" accept=".csv,.xls,.xlsx" ref={fileInputRef} />
          </label>
          <CustomButton type="primary" buttonText="Submit" handleButtonClick={onSubmitFile} />
        </div>
        <p className="segments-download-sample-file" onClick={onDownloadFile}>
  ...
  return (
    <FirstPartyWrapper>
      ...
      <p className="pt10 pb10">
        ...
        <a className="bold" href="ftp://ftpupload.adcuratio.net">
          ftpupload.adcuratio.net
        </a>
