...
import NetworkLogsViewPlan from './components/NetworkLogsViewPlan';
import { networkLogsTableTitles } from './components/NetworkLogsJsonData';
import Header from './components/Header';
import ModalData from './components/UploadModal';
import TableContainerMain from './components/TableContainer';

import withStore from '../../hocs/WithStore';

const UnivisionNetworkLogs = inject(
  'univisionStore',
  'uiStore'
)(
  observer((props) => {
...
export default withStore(UnivisionNetworkLogs);
