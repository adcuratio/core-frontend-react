              ...
              temp[index].template.filters[filterIndex].comboFilters.forEach((fil) => {
                fil.forEach((fill) => {
                  if (fill.filter_name.slice(0, -2) === 'vehicle_make' && fill.filter_name === values[2][0]) {
                    ...
                    this.props.univisionStore.modelYearForVehicleMake.model_year.forEach((model) => {
                      if (model.model === values[2][1]) {
  ...
  handleSelectAllOrNoneFiltersForExperian = (id, title, type, subCatData) => {
    ...
    if (id === 'experian_non_auto') {
      ...
      type === 'all'
        ...
        : experianFilters[indexOfCat].template.filters.forEach((fil) => (fil.isFilterSelected = false));
            ...
            <div className="">
              ...
              <div className="flex-container6">
                <div className="mt10 ml-auto">
                  ...
                  />
                  <CustomButton type="secondary" buttonText="Cancel" handleButtonClick={this.onCancelSegment} />
                </div>
              </div>
            </div>
          </div>
              ...
              {activeFilterTab.value === 5 && (
                <div className="mt10">
                  ...
                  <input
                    ...
                    style={{ width: '34vw' }}
                    onChange={(e) => this.onSegmentDataChange(e, 'liveRampCount')}
                  />
                </div>
              )}
              {activeFilterTab.value === 6 && (
                <div className="mt10">
                  ...
                  <input
                    ...
                    style={{ width: '34vw' }}
                    onChange={(e) => this.onSegmentDataChange(e, 'firstPartyCount')}
                  />
                </div>
              )}
              <div className="flex-container6">
    ...
    if (activeFilterTab.value === 1) {
      ...
      Object.keys(tempObj).forEach((key) => {
        Object.keys(tempObj[key]).forEach((index) => {
          if (tempObj[key][index] === undefined || (key === 'Geographic' && tempObj[key][index].length === 0)) {
      ...
      this.props.univisionStore.createAudienceRequest(liveRamppayload).then((res) => {
        if (res) {
          const message = 'Audience created successfully';
          showAckMessage({ message });
          this.props.navigationService.goToUnivisionViewAudience(tableState);
      ...
      if (this.state.firstPartyCount < 0) {
        showAckErrorMessage({ message: 'FirstParty Count cannot be negative!' });
        return;
      }
      ...
      this.props.univisionStore.createAudienceRequest(firstPartyPayload).then((res) => {
        if (res) {
          const message = 'Audience created successfully';
          showAckMessage({ message });
          this.props.navigationService.goToUnivisionViewAudience(tableState);
